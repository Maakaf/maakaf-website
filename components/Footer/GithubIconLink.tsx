...
const GithubIconLink: React.FC<GithubIconLinkProps> = ({ repoUrl }) => {
    return (
        ...
        <svg
            ...
            className="text-transparent transition duration-300 cursor-pointer fill-current hover:text-blue-700 transform translate-y-3 stroke-[#020616] dark:stroke-[#dddfe7]"
            >
            <g id="GitHub-Icon">
                <path
