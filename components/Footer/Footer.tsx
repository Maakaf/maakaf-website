...
const Footer: React.FC = () => {
  return (
    <footer className="grid py-6 mt-8 md:grid-cols-2 border-t-[1px] w-full h-96 md:h-40 border-blue-600 bg-lightBg dark:bg-darkAccBg text-darkText dark:text-lightText">
