...
export default function Paths() {
  return (
    <section className="flex flex-col justify-start py-32 darkmode-section">
      <div  data-testid={`pathsTitle`} className="flex flex-col-reverse md:flex-row self-start md:items-center">
        <SectionTitle title="המסלולים שלנו" />
      </div>
      <div data-testid={`pathsTitleContainer`} className="flex flex-row grow flex-wrap justify-evenly gap-y-20 mt-6 py-4 md:gap-y-4 md:py-20 lg:mt-0 lg:flex-row lg:py-20">
