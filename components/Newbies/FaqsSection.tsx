...
const FaqsSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: <p>{t('whyOpenSourceImportantAnswer')}</p>,
    },
    {
      question: t('whyContributeOpenSource'),
      answer: <p>{t('whyContributeOpenSourceAnswer')}</p>,
    },
    {
      question: t('openSourceForEveryone'),
      answer: <p>{t('openSourceForEveryoneAnswer')}</p>,
    },
    {
      question: t('openSourceForNewbies'),
      answer: <p>{t('openSourceForNewbiesAnswer')}</p>,
    },
    {
    ...
    },
    {
      ...
      answer: <p>{t('howToContributeAnswer')}</p>,
    },
  ];
  return (
