        ...
        <div className="px-4 mx-auto text-center text-[#020616] dark:text-[#F8FAFC]">
            ...
            <div className="w-[316px] md:w-[720px] flex flex-col gap-5 text-xl mb-5">
                ...
                <p className="font-medium text-xl md:text-2xl leading-7">
                    טקסט קצר שמסביר את הרעיון של קוד פתוח, קצת מעודד, מספר להם שכולם התחילו מאיפשהוולא נולדו עם הידע,
                    ושיש להם פלטפורמה מיוחדת שנוצרה בקוד פתוח בדיוק כדי לתרגל את זה ולתת להם ביטחון להצטרף לקהילה
